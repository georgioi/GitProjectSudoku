...
public class DuidokuGamePanel extends Board{
    ...
    private JButton duidokuGamePanelGoBackButton, duidokuHintButton;
    private JPopupMenu duidokuHintMenu;
    private JMenuItem duidokuAcceptableNumbers;
    private JLabel duidokuTitle, blackBoxExplain1, blackBoxExplain2;
    private Font duidokuTitleFont;
